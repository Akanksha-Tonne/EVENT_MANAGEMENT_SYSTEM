<?php
 	...
 	if (!(isset($_SESSION['userid'])))
 	{
 		...
 		$result = pg_query("select fname_fk_t, dname_fk ,count(*) from task group by fname_fk_t, dname_fk having fname_fk_t='".$fname."' and dname_fk='".$dname."';");
 		$row = pg_fetch_row($result);
 	}
?>
<!DOCTYPE html>
		...
		<div class="container-login100" style="background-image: url('images/bg.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form" name="frmUser" method="post" action="">
					...
					<div>
							<?php
					$res = pg_query("SELECT vid,vname FROM volunteer WHERE dname_fk_v='".$dname."' and fname_fk_v = '".$fname."';");
...
foreach ($_POST as $key=>$value)
		...
		if(!$result)
		{
			...
			echo "<script>location.href = 'task_form/addTask.php'</script>";
		}
