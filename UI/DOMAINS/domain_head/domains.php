...
<html>
	...
	<body>
		...
		<nav class="navbar sticky-top navbar-light bg-light" style="background-color: rgba(255, 255, 255, 0.65);">
				  <span class="navbar-brand mb-0 h1"><a href="domains.php">Home</a></span>
			...
			<div id="wrapper">
				...
				<!-- Header -->
					...
					<header id="header">
						...
						<h1><?php echo $dname; ?><br><strong><?php echo $dcoord_name; ?><br></strong><?php echo$_SESSION['userid']; ?><br /></h1>
					</header>
						...
						<!-- Thumbnails -->
							<section class="thumbnails" style="display: flex;justify-content: center;">
								<div>
									...
									<a href="/UI/DOMAINS/domain_head/Rem-form/remVolunteer.php"><h3>Remove Volunteer</h3></a>
								</div>
								<div>
